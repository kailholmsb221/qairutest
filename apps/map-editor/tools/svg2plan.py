...
FLOORS = {
    ...
    'floor-2': {
        ...
        # ответвления коридора, отрезанные от главного проёмами: западный проход к 213/209/206, полоса над WC,
        # проход между 203 и 204, полосы вокруг 227 — иначе они становятся серыми «помещениями»
        'corridor': [(285, 257), (300, 387), (342, 467), (397, 239), (409, 542), (987, 213), (1224, 244), (1285, 339)],
    },
}
