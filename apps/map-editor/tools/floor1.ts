 ...
 * точка внутри грани → id/номер/название/тип. Названия — по программе здания (ru/kk/en в room-codes.json).
 */
import { buildFromTraced, loadTraced, type Identity } from './tracedPlan';

const identity: Identity[] = [
  { at: [1053, 815], id: 'f1-100', number: '100', name: 'Актовый зал', type: 'hall' },
  { at: [1282, 690], id: 'f1-101', number: '101', name: 'Учебная лаборатория', type: 'class' },
  { at: [1475, 356], id: 'f1-102', number: '102', name: 'Библиотека', type: 'hall' },
  { at: [1371, 550], id: 'f1-102a', number: '102', name: 'Библиотека', type: 'hall' },
  { at: [1341, 210], id: 'f1-103', number: '103', name: 'Медицинский пункт', type: 'office' },
